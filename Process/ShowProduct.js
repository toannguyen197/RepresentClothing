...
function render(arrContainer){
    ...
    for (let v of arrContainer) {
      str += '<div class="card fade"><div class="card-effect"><div class="card-front effect"><img src="' + v.imgFront + '" height="300px" width="300px"></div>' +
        '<div class="card-back effect"><img src="' + v.imgBack + '" height="300px" width="300px"></div></div>' +
